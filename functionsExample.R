...
sdsPolishParMH <- TestPar(odsH,m = 1000)
sdsPolishDecMH <- TestDec(odsH,m = 1000)
sdsPolishParMTH <- TestPar(odsH,m = 1000,proper = TRUE)
sdsPolishDecMTH <- TestDecPF(odsH,m = 1000)
save(list=paste0("sds","Polish",c("Par","Par","Dec","Dec"),"M",c("","T"),"H"),file="sdsPolishMH.RData")
rm(list=paste0("sds","Polish",c("Par","Par","Dec","Dec"),"M",c("","T"),"H"))


methods <- rep("catall",14)
methods[c(2,5,8,13,14)] <- "pmm"

sdsPolishCatMPH <- TestCAP(odsH,methods,c(c(1,3,4,6,7,9:12),c(2,5,8,13,14)),m = 1000)
sdsPolishCatMPTH <- TestCAP(odsH,methods,c(c(1,3,4,6,7,9:12),c(2,5,8,13,14)),m = 1000,proper = TRUE)

methods <- rep("catall",14)
methods[c(2,5,8,13,14)] <- "cart"

sdsPolishCatMCH <- TestCAC(odsH,methods,c(c(1,3,4,6,7,9:12),c(2,5,8,13,14)),m = 1000)
sdsPolishCatMCTH <- TestCAC(odsH,methods,c(c(1,3,4,6,7,9:12),c(2,5,8,13,14)),m = 1000,proper = TRUE)

save(list=paste0("sds","PolishCatM",c("P","P","C","C"),"",c("","T"),"H"),file="sdsPolishMSH.RData")
rm(list=paste0("sds","PolishCatM",c("P","P","C","C"),"",c("","T"),"H"))


avilaODSH <- avilaODS[1:5215,]

sdsAvilaParMH <- TestPar(avilaODSH,m = 1000)
sdsAvilaDecMH <- TestDec(avilaODSH,m = 1000)
sdsAvilaParMTH <- TestPar(avilaODSH,m = 1000,proper = TRUE)
sdsAvilaDecMTH <- TestDec(avilaODSH,m = 1000,proper = TRUE)
save(list=paste0("sds","Avila",c("Par","Par","Dec","Dec"),"M",c("","T"),"H"),file="sdsAvilaMH.RData")
rm(list=paste0("sds","Avila",c("Par","Par","Dec","Dec"),"M",c("","T"),"H"))
...
sdsAvilaCatMPH <- TestCAP(avilaODSH,methods,c(11,1:10),m = 1000)
sdsAvilaCatMPTH <- TestCAP(avilaODSH,methods,c(11,1:10),m = 1000,proper = TRUE)

methods <- rep("cart",11)
methods[11] <- "catall"


sdsAvilaCatMCH <- TestCAC(avilaODSH,methods,c(11,1:10),m = 1000)
sdsAvilaCatMCTH <- TestCAC(avilaODSH,methods,c(11,1:10),m = 1000,proper = TRUE)

save(list=paste0("sds","AvilaCatM",c("P","P","C","C"),"",c("","T"),"H"),file="sdsAvilaMSH.RData")
rm(list=paste0("sds","AvilaCatM",c("P","P","C","C"),"",c("","T"),"H"))
...
sds <- paste0("sds","Adult",c("Dec","Dec"),"M",c("","T"),"S")
glm <- paste0("glm","Adult",c("Dec","Dec"),"M",c("","T"),"S")
est <- paste0("est","Adult",c("Dec","Dec"),"M",c("","T"),"S")
kld <- paste0("kld","Adult",c("Dec","Dec"),"M",c("","T"),"S")
...
save(list = glm,file = "glmAdultMSm.RData")
save(list = est,file = "estAdultMSm.RData")
save(list = kld,file = "kldAdultMSm.RData")
rm(list = glm)
rm(list = est)
rm(list = kld)
...
sds <- paste0("sds","Adult",c("Dec","Dec"),"MH",c("","T"),"S")
glm <- paste0("glm","Adult",c("Dec","Dec"),"MH",c("","T"),"S")
est <- paste0("est","Adult",c("Dec","Dec"),"MH",c("","T"),"S")
kld <- paste0("kld","Adult",c("Dec","Dec"),"MH",c("","T"),"S")
...
save(list = glm,file = "glmAdultMHSm.RData")
save(list = est,file = "estAdultMHSm.RData")
save(list = kld,file = "kldAdultMHSm.RData")
rm(list = glm)
rm(list = est)
rm(list = kld)
...
sds <- paste0("sds","Adult",c("Dec","Dec"),"ML",c("","T"),"S")
glm <- paste0("glm","Adult",c("Dec","Dec"),"ML",c("","T"),"S")
est <- paste0("est","Adult",c("Dec","Dec"),"ML",c("","T"),"S")
kld <- paste0("kld","Adult",c("Dec","Dec"),"ML",c("","T"),"S")
...
save(list = glm,file = "glmAdultMLSm.RData")
save(list = est,file = "estAdultMLSm.RData")
save(list = kld,file = "kldAdultMLSm.RData")
rm(list = glm)
rm(list = est)
rm(list = kld)
...
sds <- paste0("sds","AdultCatM",c("P","P","C","C"),"",c("","T"),"S")
glm <- paste0("glm","AdultCatM",c("P","P","C","C"),"",c("","T"),"S")
est <- paste0("est","AdultCatM",c("P","P","C","C"),"",c("","T"),"S")
kld <- paste0("kld","AdultCatM",c("P","P","C","C"),"",c("","T"),"S")
...
save(list = glm,file = "glmAdultMSSm.RData")
save(list = est,file = "estAdultMSSm.RData")
save(list = kld,file = "kldAdultMSSm.RData")
rm(list = glm)
rm(list = est)
rm(list = kld)
...
sds <- paste0("sds","Polish",c("Par","Par","Dec","Dec"),"M",c("","T"),"H")
glm <- paste0("glm","Polish",c("Par","Par","Dec","Dec"),"M",c("","T"),"H")
est <- paste0("est","Polish",c("Par","Par","Dec","Dec"),"M",c("","T"),"H")
kld <- paste0("kld","Polish",c("Par","Par","Dec","Dec"),"M",c("","T"),"H")

for(i in c(1:length(sds))){
  act <- eval(as.name(sds[[i]]))
  actG <- TestGLM(act,odsH,c(1,2,3,5,10,20,50,100),1000,test,test2)
  actE <- TestEst(act,odsH,mean,var,c(2,5,8,13,14),c(1,2,3,5,10,20,50,100),1000)
  actK <- TestKLD(act,odsH)
  assign(as.character(glm[[i]]),actG)
  assign(as.character(est[[i]]),actE)
  assign(as.character(kld[[i]]),actK)
}
...
save(list = glm,file = "glmPolishMH.RData")
save(list = est,file = "estPolishMH.RData")
save(list = kld,file = "kldPolishMH.RData")
rm(list = glm)
rm(list = est)
rm(list = kld)
...
sds <- paste0("sds","PolishCatM",c("P","P","C","C"),"",c("","T"),"H")
glm <- paste0("glm","PolishCatM",c("P","P","C","C"),"",c("","T"),"H")
est <- paste0("est","PolishCatM",c("P","P","C","C"),"",c("","T"),"H")
kld <- paste0("kld","PolishCatM",c("P","P","C","C"),"",c("","T"),"H")
...
save(list = glm,file = "glmPolishMSH.RData")
save(list = est,file = "estPolishMSH.RData")
save(list = kld,file = "kldPolishMSH.RData")
rm(list = glm)
rm(list = est)
rm(list = kld)
...
sds <- paste0("sds","Avila",c("Par","Par","Dec","Dec"),"M",c("","T"),"H")
glm <- paste0("glm","Avila",c("Par","Par","Dec","Dec"),"M",c("","T"),"H")
est <- paste0("est","Avila",c("Par","Par","Dec","Dec"),"M",c("","T"),"H")
kld <- paste0("kld","Avila",c("Par","Par","Dec","Dec"),"M",c("","T"),"H")

for(i in c(1:length(sds))){
  act <- eval(as.name(sds[[i]]))
  actG <- TestGLM(act,avilaODSH,c(1,2,3,5,10,20,50,100),1000,test,test2)
  actE <- TestEst(act,avilaODSH,mean,var,c(1:10),c(1,2,3,5,10,20,50,100),1000)
  actK <- TestKLD(act,avilaODSH)
  assign(as.character(glm[[i]]),actG)
  assign(as.character(est[[i]]),actE)
  assign(as.character(kld[[i]]),actK)
}
...
save(list = glm,file = "glmAvilaMH.RData")
save(list = est,file = "estAvilaMH.RData")
save(list = kld,file = "kldAvilaMH.RData")
rm(list = glm)
rm(list = est)
rm(list = kld)
...
sds <- paste0("sds","AvilaCatM",c("P","P","C","C"),"",c("","T"),"H")
glm <- paste0("glm","AvilaCatM",c("P","P","C","C"),"",c("","T"),"H")
est <- paste0("est","AvilaCatM",c("P","P","C","C"),"",c("","T"),"H")
kld <- paste0("kld","AvilaCatM",c("P","P","C","C"),"",c("","T"),"H")
...
save(list = glm,file = "glmAvilaMSH.RData")
save(list = est,file = "estAvilaMSH.RData")
save(list = kld,file = "kldAvilaMSH.RData")
rm(list = glm)
rm(list = est)
rm(list = kld)
...
avilaODSFH <- createFac(avilaODSH,avilaODSH,cbind(c(1:10),2),c(colnames(avilaODSH),paste0(colnames(avilaODSH)[c(1:10)],"G")))

colnames(avilaODSFH)[[21]] <- "MR_ISG"

avilaODSKH <- localSuppression(avilaODSFH,keyVars = c(11,12:21))$xAnon

colnames(avilaODSFH)[[21]] <- "MR/ISG"

colnames(avilaODSKH)[[11]] <- "MR/ISG"
...
sds <- paste0("sds","Avila",c("Par","Par","Dec","Dec"),"M",c("","T"),"H")
glmNK <- paste0("glm","Avila",c("Par","Par","Dec","Dec"),"M",c("","T"),"KH")

for(i in c(1:length(sds))){
  act <- eval(as.name(sds[[i]]))
  actG <- testGLMK(act,avilaODSFH,c(1,2,3,5,10,20,50,100),1000,testK,testK2,cbind(c(1:10),2))
  assign(as.character(glmNK[[i]]),actG)
}
...
sds <- paste0("sds","AvilaCatM",c("P","P","C","C"),"",c("","T"),"H")
glmSK <- paste0("glm","AvilaCatM",c("P","P","C","C"),"",c("","T"),"KH")
...
save(list = c(glmNK,glmSK),file = "glmAvilaKH.RData")
